...
import 'package:loopcare_frontend/core/presentation/nutrition/nutrition_summary/calories_tracker.dart';
    ...
    return MainContainer(
      child: Column(
        children: [
          ...
          if (showCaloriesTracker) CaloriesTracker(totalCalories: totalCalories),
        ],
      ),
    );
  }
