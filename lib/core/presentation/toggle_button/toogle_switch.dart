          ...
          child: RowToColumn(
            ...
            children: List.generate(totalSwitches * 2 - 1, (index) {
              ...
              if (index % 2 == 1) {
                ...
                var icon = widget.icons != null && widget.icons![index ~/ 2] != null
                    ? Icon(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Flexible(
                          child: Container(
                            padding: EdgeInsets.only(left: (icon is Container) ? 0.0 : 5.0),
                            child: Text(
                              widget.labels?[index ~/ 2] ?? '',
                              textAlign: (widget.centerText) ? TextAlign.center : null,
                              style: active ? widget.customActiveTextStyles : textStyle,
