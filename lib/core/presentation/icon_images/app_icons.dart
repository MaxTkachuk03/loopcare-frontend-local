...
class AppIcons {
  ...
  static const String educationUnlocked =
      'assets/images/education_unlocked.png';
  static const String vector = 'assets/images/weight.png';
  static const String commitmentUnlocked =
      'assets/icons/commitment_unlocked.png';
  static const String reflectionUnlocked =
      'assets/icons/reflection_unlocked.png';
  ...
  static const String moodMeterUnlocked =
      'assets/icons/mood_meter_unlocked.png';
  ...
  static const AssetImage reflectionCheckMark =
      AssetImage('$iconsFilePath/reflection_checkmark.png');
  static const AssetImage reflectionLocked =
      AssetImage('$iconsFilePath/reflection_locked.png');
  ...
  static SvgPicture mindInsightsGoals = SvgPicture.asset(
      '$iconsFilePath/medical_insights.svg',
      width: 44,
      height: 44);

  static SvgPicture physicalActivityGoals = SvgPicture.asset(
      '$iconsFilePath/physical_activity_goal.svg',
      width: 44,
      height: 44);
  static SvgPicture communityGoals =
      SvgPicture.asset('$iconsFilePath/community.svg', width: 44, height: 44);

  static SvgPicture deleteGoals = SvgPicture.asset(
      '$iconsFilePath/delete_goals.svg',
      width: 28,
      height: 28);
  ...
  static SvgPicture commitmentLocked = SvgPicture.asset(
      '$iconsFilePath/commitment_locked.svg',
      width: 44,
      height: 44);
  ...
  static SvgPicture customDashboardSmartGoals = SvgPicture.asset(
      ...
      width: 44,
      height: 44);
  static SvgPicture customDashboardSmartGoalsBlue = SvgPicture.asset(
      '$iconsFilePath/smart_goal_dark_blue.svg',
      width: 44,
      height: 44);
  static SvgPicture customDashboardSmartGoalsGrey =
      SvgPicture.asset('$iconsFilePath/my_goals.svg', width: 44, height: 44);
  static SvgPicture customMyGoalIcon = SvgPicture.asset(
      '$iconsFilePath/my_goal_icon.svg',
      width: 44,
      height: 44);
...
// nutrition intake
  ...
  static SvgPicture commitmentButton =
      SvgPicture.asset('$iconsFilePath/commitment_intake.svg');
  static SvgPicture intakePlus =
      SvgPicture.asset('$iconsFilePath/intake_plus.svg');
