...
class AppImages {
  ...
  static const AssetImage physicalIntro =
      AssetImage('$imagesFilePath/new_physical_intro.png');

  static const AssetImage medicalIntro =
      AssetImage('$imagesFilePath/new_medical_intro.png');

  static const AssetImage mentalIntro =
      AssetImage('$imagesFilePath/new_mental_intro.png');

  static const AssetImage welcome =
      AssetImage('$imagesFilePath/new_welcome.png');

  static const AssetImage foodPreferences =
      AssetImage('$imagesFilePath/new_food_preferences.png');

  static const AssetImage logo = AssetImage('$imagesFilePath/logo.png');

  static SvgPicture oepsBig =
      SvgPicture.asset('$imagesFilePath/oeps.svg', width: 120, height: 120);

  static SvgPicture oepsSmall =
      SvgPicture.asset('$imagesFilePath/oeps.svg', width: 60, height: 60);

  static SvgPicture noConnectionBig = SvgPicture.asset(
      '$imagesFilePath/no_connection.svg',
      width: 120,
      height: 120);

  static SvgPicture noConnectionSmall = SvgPicture.asset(
      '$imagesFilePath/no_connection.svg',
      width: 60,
      height: 60);
  ...
  static SvgPicture bottomFrame =
      SvgPicture.asset('$imagesFilePath/bottom_frame.svg');

  static const AssetImage educationPreview =
      AssetImage('$imagesFilePath/new_education_preview.png');
  static SvgPicture subscriptionTop =
      SvgPicture.asset('$imagesFilePath/konfetti.svg');
  static const AssetImage buddyIntro =
      AssetImage('$imagesFilePath/buddy_intro.png');
  ...
  static const AssetImage onboardingPacing =
      AssetImage('$imagesFilePath/onboarding_pacing.png');

  static SvgPicture onboardingArrow =
      SvgPicture.asset('$imagesFilePath/onboarding_arrow.svg');
  static SvgPicture subscriptionCross =
      SvgPicture.asset('$imagesFilePath/subscription_cross.svg');

  static const AssetImage nutrition =
      AssetImage('$imagesFilePath/nutrition_image.png');
}
