...
class ModalBottomSheet {
            ...
            child: MainContainer(
              child: Column(
                ...
                children: [
                  ...
                  CustomOutlinedButton.blueFullWidth(
                    onPressed:
                        noActiveSubscription ? onDeleted : onSubscriptionPref,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            final item = list[index];
                            final isFilled = filledList
                                .contains(item.shortValue.toLowerCase());
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20.0),
                CustomText.w400(
                    LocalizedTexts.avatarSizeErrorMessageSubtitle.tr(),
                    style: context.textTheme.bodyMedium),
                Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                CustomText.w600(
                  Platform.isAndroid
                      ? LocalizedTexts.avatarGaleryPermissionsMessageAndroid
                          .tr()
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20.0),
                  CustomText.w600(
                    LocalizedTexts.buddyFindAnotherBuddyLabel
                        .tr({"name": name}),
                    style: context.textTheme.bodyMedium,
                  ),
                  const SizedBox(height: 20.0),
        ...
        return MainContainer(
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                SizedBox(
                    width: 44, height: 44, child: AppIcons.lightbulbUnSelect),
                const SizedBox(height: 20.0),
                CustomText.bitter600(
                  title,
                  style: context.textTheme.displayMedium,
  ...
  static void showDocumentsUpdate({
    ...
    showModalBottomSheet<void>(
      ...
      builder: (BuildContext context) {
        return SingleChildScrollView(
          child: AppUpdatePoliciesDocuments(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24.0),
                CustomText.w600(
                  LocalizedTexts.riverModuleCompletedTitle
                      .tr({'module': currentModule}),
                  style: context.textTheme.bodyMedium,
                ),
                const SizedBox(height: 20.0),
                CustomText.w400(
                  LocalizedTexts.riverModuleCompletedDescription
                      .tr({'nextModule': nextModule}),
                  style: context.textTheme.bodyMedium,
                ),
                const SizedBox(height: 20.0),
                CustomElevatedButton.blueFullWidth(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20.0),
                CustomText.w400(
                  LocalizedTexts.riverModuleGraduationCompletedItemsMessage
                      .tr(),
                  style: context.textTheme.bodyMedium,
                ),
                const SizedBox(height: 20.0),
