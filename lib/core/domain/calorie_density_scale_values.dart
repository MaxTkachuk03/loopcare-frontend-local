...
final List<Range> calorieDensityScaleValues = [
  Range(min: 0, max: 0.99, color: const Color(0xFF24CB35)),
  Range(min: 1, max: 1.29, color: const Color(0xFF60BB3F)),
  Range(min: 1.3, max: 1.49, color: const Color(0xFF73B642)),
  Range(min: 1.5, max: 1.64, color: const Color(0xFF94AC48)),
  Range(min: 1.65, max: 1.74, color: const Color(0xFFCD9D52)),
