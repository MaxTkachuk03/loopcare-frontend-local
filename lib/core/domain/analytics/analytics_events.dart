class AnalyticsEvents {
  ...
  static String get lessonCompleteFoodPreferencesScreen =>
      'lesson_complete_food_preferences_screen';

  static String get reflectionsSavedScreen => 'reflections_saved_screen';
  ...
  static String get userOpenedReflection => 'user_opened_reflection';

  static String get userCompleteReflection => 'user_complete_reflection';

  static String get userLeftReflection => 'user_left_reflection';

  static String get reflectionMotivationScale => 'reflection_motivation_scale';
  ...
  static String get mindTechniqueExplanation => 'mind_open_technique_explanation';

  static String get mindCloseTechniqueExplanation => 'mind_close_technique_explanation';
