...
class _SubscriptionPageV2State extends State<SubscriptionPageV2> {
  ...
  void _onCheckMethod(int index, bool isChecked) {
    setState(() {
      selectedPlanIndex = isChecked ? 10000000000 : index;
    });
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      CategoryLabel.subscription(label: state.data.label),
                      ...
                      const SizedBox(height: 10.0),
                      CustomText.w400(state.data.subText, style: context.textTheme.bodySmall),
                    ],
                  ),
                ),
                Expanded(
