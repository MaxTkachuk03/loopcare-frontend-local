...
import 'package:loopcare_frontend/features/subscriptionV2/infrastructure/subscription_service_v2.dart';
import 'package:loopcare_frontend/injection.dart';
import 'package:loopcare_frontend/localization/service/localized_texts.dart';

class PurchaseDetailsStreamSubscriptionV2 {
  final AppSubscriptionServiceV2 inAppPurchaseService = getIt<AppSubscriptionServiceV2>();
  ...
  PurchaseDetailsStreamSubscriptionV2({
    this.onPending,
    this.onPurchased,
    this.onEmpty,
    this.onError,
