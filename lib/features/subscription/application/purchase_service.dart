...
abstract class PurchaseService {
  ...
  Future<Either<RequestError, ValidStatus>> verifyPurchaseIOS(VerifyIOSPurchaseData? receipt, String vendor);

  Future<Either<RequestError, ValidStatus>> verifyPurchaseAndroid(VerifyAndroidPurchaseData? receipt, String vendor);
