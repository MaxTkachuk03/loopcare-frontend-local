...
import '../../../../../core/presentation/line_chart/line_chart.dart';
                  ...
                  widget.unlocked
                      ? Column(
                          children: [
                            CustomText.w600(
                              maxLines: 1,
                              LocalizedTexts.weightProgressionTitle.tr(),
                              style: context.textTheme.titleLarge!
                                  .copyWith(color: AppColors.blueDarker),
                              overflow: TextOverflow.visible,
                            ),
                            CustomText.w400(
                              maxLines: 1,
                              LocalizedTexts.weekDates.tr({
                                'from':
                                    '${widget.startDate.day} ${widget.startDate.shortMonthString}',
                                'to': '${widget.endDate.day} ${widget.endDate.shortMonthString}',
                                'month': '',
                              }),
