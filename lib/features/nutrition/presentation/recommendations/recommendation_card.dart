...
part 'recommendation_card.freezed.dart';

@freezed
class RecommendationCardSize with _$RecommendationCardSize {
  const factory RecommendationCardSize.small() = Small;

  const factory RecommendationCardSize.large() = Large;
}
