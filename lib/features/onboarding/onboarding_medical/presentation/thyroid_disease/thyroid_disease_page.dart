...
import 'package:loopcare_frontend/features/onboarding/onboarding_medical/presentation/thyroid_disease/widgets/thyroid_disease_chips.dart';
import 'package:loopcare_frontend/features/onboarding/presentation/progress_bar.dart';

class ThyroidDiseasePage extends StatelessWidget {
  const ThyroidDiseasePage({super.key});
    ...
    return MedicalQuestionWrap(
      child: CustomScaffold.blueLightest(
        appBar: CustomAppBar.blue(
          ...
          subtitle: LocalizedTexts.stepCounter.tr(args: ['5', '16']),
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomText.bitter600(
                        '${LocalizedTexts.thyroidDiseaseQuestion.tr()}?',
                        textAlign: TextAlign.center,
                        style: context.textTheme.displayMedium,
                      ),
                      const SizedBox(height: 36.0),
                      const ThyroidDiseaseChips(),
                    ],
                  ),
                ),
              ],
