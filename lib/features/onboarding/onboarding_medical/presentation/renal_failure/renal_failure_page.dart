...
import 'package:loopcare_frontend/features/onboarding/onboarding_medical/presentation/renal_failure/widgets/renal_failure_chips.dart';
import 'package:loopcare_frontend/features/onboarding/presentation/progress_bar.dart';

class RenalFailurePage extends StatelessWidget {
  const RenalFailurePage({super.key});
    ...
    return MedicalQuestionWrap(
      child: CustomScaffold.blueLightest(
        appBar: CustomAppBar.blue(
          ...
          subtitle: LocalizedTexts.stepCounter.tr(args: ['11', '16']),
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomText.bitter600(
                        '${LocalizedTexts.renalFailureQuestion.tr()}?',
                        textAlign: TextAlign.center,
                        style: context.textTheme.displayMedium,
                      ),
                      const SizedBox(height: 36.0),
                      const RenalFailureChips(),
                    ],
                  ),
                ),
              ],
