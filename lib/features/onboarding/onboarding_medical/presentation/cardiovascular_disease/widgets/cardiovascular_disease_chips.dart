...
class _CardiovascularDiseaseChipsState extends State<CardiovascularDiseaseChips> {
  ...
  void _onSelected(YesNoAnswer value) {
    ...
    value == YesNoAnswer.yes
        ? bloc.add(const MedicalFitnessEvent.addDisease(Diseases.cardioVascularDisease))
        : bloc.add(const MedicalFitnessEvent.removeDisease(Diseases.cardioVascularDisease));

    AnalyticsEventService.instance.logEvent(
      FirebaseEvents.userHeartSurgery,
      parameters: {
