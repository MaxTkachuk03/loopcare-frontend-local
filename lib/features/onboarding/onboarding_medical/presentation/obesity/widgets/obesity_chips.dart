...
class ObesityChips extends StatefulWidget {
  const ObesityChips({super.key});

  @override
  State<ObesityChips> createState() => _ObesityChipsState();
}

class _ObesityChipsState extends State<ObesityChips> {
  ...
  void _onSelected(YesNoAnswer value) {
    ...
    value == YesNoAnswer.yes
        ? bloc.add(const MedicalFitnessEvent.addDisease(Diseases.obesity))
        : bloc.add(const MedicalFitnessEvent.removeDisease(Diseases.obesity));
