...
import 'package:loopcare_frontend/features/onboarding/onboarding_medical/presentation/obesity/widgets/obesity_chips.dart';
    ...
    return MedicalQuestionWrap(
      child: CustomScaffold(
        appBar: CustomAppBar.blue(
          ...
          subtitle: LocalizedTexts.stepCounter.tr(args: ['4', '16']),
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomText.bitter600(
                        '${LocalizedTexts.obesityQuestion.tr()}?',
