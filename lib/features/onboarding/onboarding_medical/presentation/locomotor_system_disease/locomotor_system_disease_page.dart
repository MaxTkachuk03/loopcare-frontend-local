...
import 'package:loopcare_frontend/features/onboarding/onboarding_medical/presentation/locomotor_system_disease/widgets/locomotor_system_disease_chips.dart';
...
class LocomotorSystemDiseasePage extends StatelessWidget {
  const LocomotorSystemDiseasePage({super.key});
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomText.bitter600(
                        '${LocalizedTexts.locomotorSystemDiseaseQuestion.tr()}?',
                        textAlign: TextAlign.center,
                        style: context.textTheme.displayMedium,
                      ),
                      const SizedBox(height: 36.0),
                      const LocomotorSystemDiseaseChips(),
                    ],
                  ),
                ),
              ],
