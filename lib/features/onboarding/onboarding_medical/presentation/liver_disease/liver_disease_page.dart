...
import 'package:loopcare_frontend/features/onboarding/onboarding_medical/presentation/liver_disease/widgets/liver_disease_chips.dart';
...
class LiverDiseasePage extends StatelessWidget {
  const LiverDiseasePage({super.key});
    ...
    return MedicalQuestionWrap(
      child: CustomScaffold.blueLightest(
        appBar: CustomAppBar.blue(
          ...
          subtitle: LocalizedTexts.stepCounter.tr(args: ['13', '16']),
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomText.bitter600(
                        '${LocalizedTexts.liverDiseaseQuestion.tr()}?',
                        textAlign: TextAlign.center,
                        style: context.textTheme.displayMedium,
                      ),
                      const SizedBox(height: 36.0),
                      const LiverDiseaseChips(),
                    ],
                  ),
                ),
              ],
