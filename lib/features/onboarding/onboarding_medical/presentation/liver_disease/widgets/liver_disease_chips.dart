...
class LiverDiseaseChips extends StatefulWidget {
  const LiverDiseaseChips({super.key});

  @override
  State<LiverDiseaseChips> createState() => _LiverDiseaseChipsState();
}

class _LiverDiseaseChipsState extends State<LiverDiseaseChips> {
  ...
  void initState() {
    ...
    _selectedValue = bloc.state.data.containsDisease(Diseases.liverDisease)
        ? bloc.state.data.getContainedDisease(Diseases.liverDisease).enable
            ? YesNoAnswer.yes
            : YesNoAnswer.no
        : null;
  }
  ...
  void _onSelected(YesNoAnswer value) {
    ...
    value == YesNoAnswer.yes
        ? bloc.add(const MedicalFitnessEvent.addDisease(Diseases.liverDisease))
        : bloc.add(const MedicalFitnessEvent.removeDisease(Diseases.liverDisease));

    AnalyticsEventService.instance.logEvent(
      FirebaseEvents.userHepatitisLiverDisease,
      parameters: {
