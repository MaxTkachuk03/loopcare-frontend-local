...
class AsthmaChips extends StatefulWidget {
  const AsthmaChips({super.key});

  @override
  State<AsthmaChips> createState() => _AsthmaChipsState();
}

class _AsthmaChipsState extends State<AsthmaChips> {
  ...
  void _onSelected(YesNoAnswer value) {
    ...
    value == YesNoAnswer.yes
        ? bloc.add(const MedicalFitnessEvent.addDisease(Diseases.asthma))
        : bloc.add(const MedicalFitnessEvent.removeDisease(Diseases.asthma));

    AnalyticsEventService.instance.logEvent(
      FirebaseEvents.userAstmaCOPD,
      parameters: {
