...
import 'package:loopcare_frontend/features/onboarding/onboarding_medical/presentation/asthma/widgets/asthma_chips.dart';
    ...
    return MedicalQuestionWrap(
      child: CustomScaffold.blueLightest(
        appBar: CustomAppBar.blue(
          ...
          subtitle: LocalizedTexts.stepCounter.tr(args: ['12', '16']),
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomText.bitter600(
                        '${LocalizedTexts.asthmaQuestion.tr()}?',
