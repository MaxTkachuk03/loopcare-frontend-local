...
class GeneralOnboardingState with _$GeneralOnboardingState {
  ...
  MedicalQuestionStep get currentMedicalStep =>
      medicalPassedStack.isNotEmpty ? medicalPassedStack.last : MedicalQuestionStep.intro;

  MentalQuestionStep get currentMentalStep =>
      mentalPassedStack.isNotEmpty ? mentalPassedStack.last : MentalQuestionStep.introStepOne;

  bool get showProgressBar =>
      currentMentalStep != MentalQuestionStep.result &&
      currentMentalStep != MentalQuestionStep.resultFailed;
