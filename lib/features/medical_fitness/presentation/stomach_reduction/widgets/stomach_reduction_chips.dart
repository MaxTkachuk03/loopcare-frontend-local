...
class _StomachReductionChipsState extends State<StomachReductionChips> {
  ...
  void initState() {
    ...
    _selectedValue = bloc.state.stomachReductionDisease;
  ...
  void _onSelected(YesNoAnswer value) {
    ...
    if (value == YesNoAnswer.yes) {
      context.router.pushNamed(AppRoutes.stomachReductionFailed);
    ...
    bloc.add(MedicalFitnessEvent.stomachReductionChanged(value));
