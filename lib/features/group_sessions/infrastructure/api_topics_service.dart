...
class APITopicsService implements TopicsService {
  ...
  Future<Either<RequestError, GroupSessionsResponse>> fetchTopics({
    ...
    return await client.get(
      ...
      fromJson: GroupSessionsResponse.fromJson,
    );
  }
  ...
  @override
  Future<Either<RequestError, dynamic>> signOutGroupMeeting(int groupSessionId) async {
    return await client.delete('/group-sessions/$groupSessionId/members');
  }
