...
class PhysicalProgramsEvent with _$PhysicalProgramsEvent {
  const factory PhysicalProgramsEvent.getProgramsByPreferences() =
      _GetProgramsByPreferences;

  const factory PhysicalProgramsEvent.createCustomActivity(String name) =
      _CreateCustomActivity;

  const factory PhysicalProgramsEvent.setProgramType(ProgramType programType) =
      _SetProgramType;
  ...
  const factory PhysicalProgramsEvent.getWeeklyPhysicalActivities() =
