...
class EducationProgramState with _$EducationProgramState {
  ...
  const factory EducationProgramState.loading(EducationProgramData data) =
      EducationProgramStateLoading;

  const factory EducationProgramState.loaded(EducationProgramData data) =
...
class EducationProgramData with _$EducationProgramData {
  ...
  int get activeLessonIndex =>
      lessons.indexWhere((element) => !element.isCompleted && !element.isLocked);
}
