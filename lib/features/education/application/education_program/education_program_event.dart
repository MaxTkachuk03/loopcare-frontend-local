...
class EducationProgramEvent with _$EducationProgramEvent {
  const factory EducationProgramEvent.getLessons(LessonCategory category) = _GetLessons;

  const factory EducationProgramEvent.resetLessonWithCountdown() = _ResetLessonWithCountdown;

  const factory EducationProgramEvent.setLessonWithCountdown(LessonCategory category) =
