...
import 'package:loopcare_frontend/features/education/domain/interactive_lesson/heading_content/heading_content.dart';
...
class InteractiveLessonChunkComponent with _$InteractiveLessonChunkComponent {
  ...
  const factory InteractiveLessonChunkComponent.heading1({
    required int id,
  ...
  const factory InteractiveLessonChunkComponent.heading2({
    ...
    required bool isValid,
    required HeadingContent content,
  }) = InteractiveLessonChunkComponentHeading2;

  const factory InteractiveLessonChunkComponent.heading3({
    required int id,
    required InteractiveLessonComponentType type,
    required bool needsValidation,
    required bool isValid,
    required HeadingContent content,
  }) = InteractiveLessonChunkComponentHeading3;

  const factory InteractiveLessonChunkComponent.paragraph({
    required int id,
    required InteractiveLessonComponentType type,
    required bool needsValidation,
    required bool isValid,
    required ParagraphContent content,
  }) = InteractiveLessonChunkComponentParagraph;

  const factory InteractiveLessonChunkComponent.bulletedList({
    required int id,
    required InteractiveLessonComponentType type,
    required bool needsValidation,
    required bool isValid,
    required ListContent content,
  }) = InteractiveLessonChunkComponentBulletedList;

  const factory InteractiveLessonChunkComponent.numberedList({
    required int id,
    required InteractiveLessonComponentType type,
    required bool needsValidation,
    required bool isValid,
    required ListContent content,
  }) = InteractiveLessonChunkComponentNumberedList;
