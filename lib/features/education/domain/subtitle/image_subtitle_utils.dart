...
List<ImageSubtitle> parseFromWebVTTString(String data) {
  final List<ImageSubtitle> subtitles = <ImageSubtitle>[];
...
List<ImageSubtitle> parseFromSubRipString(String data) {
  final List<ImageSubtitle> subtitles = <ImageSubtitle>[];
  ...
  for (final List<String> subtitleLine in subtitleStrings) {
    ...
    subtitles.add(ImageSubtitle(
      ...
      src: extractTextFromHtml(subtitleLine.sublist(2).join('\n')),
    ));
  }
