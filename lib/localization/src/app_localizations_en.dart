...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get errorSubscriptionAccountIdInvalid => 'It looks like your Apple ID already has a subscription on another LeanOnMe account. Please log in with that email address to use your subscription. If you need assistance, please contact support@lean-on.me';
  ...
  @override
  String get onboardingPhysicalIntroBody => 'Joshua needs to know the answers to some basics so we can customize your program.';

  @override
  String get onboardingAgeCheckFailedTitle => 'We are sorry. Unfortunately, your enrollment is not possible now.';

  @override
  String get onboardingAgeCheckFailedBody => 'Our program is not set up for people under the age of 18';

  @override
  String get onboardingWhatYourSex => 'What is your sex?';

  @override
  String get onboardingSexQuestionBody => 'Please indicate what biological sex should be used to calculate certain metrics that will help to properly tailor the program to you.';
  ...
  @override
  String get onboardingHappinessBody2 => 'Using the scale below, please indicate how you generally feel, when you think about your current lifestyle.';
  ...
  @override
  String get onboardingHeightSmall => 'Are you sure this is the correct height? Seems rather small. Please correct your input';

  @override
  String get onboardingHeightLarge => 'Are you sure this is the correct height? Seems rather large. Please correct your input';
  ...
  @override
  String get onboardingHighBmiDescription1 => 'LeanOnMe currently has customized programs to support people with a BMI between 25 and 40. We are working on additional customizations to help support people who are outside this BMI range, but we’re not quite there yet.';

  @override
  String get onboardingHighBmiDescription2 => 'Some parts of our current program may not be 100% tailored to your needs.';

  @override
  String get onboardingHighBmiDescription3 => 'Listen to your body, and if you have any concerns that something is not right for you, please contact support@lean-on.me.';

  @override
  String get onboardingLowerBmiDescription1 => 'According to your BMI, you’re within a healthy range, that’s great! But LeanOnMe’s program is designed to support people living with various degrees of overweight and obesity.';

  @override
  String get onboardingLowerBmiDescription2 => 'None of our content is bad for you! But some may not feel as relevant. Enjoy!';

  @override
  String get onboardingBmiExclusionBody1 => 'Your BMI indicates that you may be underweight. LeanOnMe is currently a weight-loss program. In respect to your current BMI, additional weight-loss could affect your health.';

  @override
  String get onboardingBmiExclusionBody2 => 'Please consult to your GP to make sure that your health is not being affected.';
  ...
  @override
  String get onboardingBmiDescription1 => 'The Body Mass Index (BMI) is a measure  that uses your height and weight to calculate if your weight for your body is within a healthy range';

  @override
  String get onboardingBmiDescriptionAccent => 'Body Mass Index (BMI)';

  @override
  String get onboardingBmiDescription2 => 'However, BMI has limitations - for example it can\'t differentiate between fat, muscle, and bone weight. We\'ll use it along with other metrics to customize your program, but don\'t worry: It won\'t be the only factor that is taken into account';
  ...
  @override
  String get onboardingMedicalIntroBody => 'To ensure that this program is suitable for your current circumstances and to tailor it specifically to you, please answer the next set of questions regarding your health conditions.';

  @override
  String get onboardingAreYouPregnant => 'Are you pregnant?';

  @override
  String get onboardingFailedPregnancyTitle => 'We are sorry. Unfortunately, your enrollment is not possible for now.';

  @override
  String get onboardingFailedPregnancyBody1 => 'You are having a baby.';

  @override
  String get onboardingFailedPregnancyBody2 => 'This program is not suitable for people who are pregnant.';

  @override
  String get onboardingFailedPregnancyBody3 => 'We would be happy to welcome you back here after your pregnancy.';

  @override
  String get onboardingFailedPregnancyBody4 => 'Wishing you all the best for you and your baby-to-be!';
  ...
  @override
  String get onboardingWeightLossMedicationQuestion => 'Are you taking any medication to help you on your weight-loss journey?';

  @override
  String get onboardingObesityQuestion => 'Have you been diagnosed with a secondary form of obesity (e.g. Cushing syndrome, Prader-Willi syndrome or hypogonadism)?';

  @override
  String get onboardingThyroidDiseaseQuestion => 'Have you been diagnosed with a thyroid disease (e.g. Hashimoto’s disease or hypothyroidism)?';

  @override
  String get onboardingMetabolicDiseaseQuestion => 'Have you been diagnosed with a form of metabolic disease?';

  @override
  String get onboardingHypertensionQuestion => 'Have you been diagnosed with hypertension?';

  @override
  String get onboardingCardiovascularDiseaseQuestion => 'Have you been diagnosed with a cardiovascular disease or did you have heart surgery in the last 12 months?';

  @override
  String get onboardingStomachReductionQuestion => 'Did you have a stomach reduction or bariatric surgery in the last 3 years or are you in a preparatory phase for such surgery?';
  ...
  @override
  String get onboardingLiverDiseaseQuestion => 'Have you been diagnosed with hepatitis or liver disease?';

  @override
  String get onboardingSleepApneaSyndromeQuestion => 'Have you been diagnosed with sleep apnea syndrome?';

  @override
  String get onboardingLocomotorSystemDiseaseQuestion => 'Have you been diagnosed with any disease of the locomotor system (e.g. arthritis, osteoporosis, back/neck pains or inflammatory disease)?';

  @override
  String get onboardingTreatmentByTheDoctorQuestion => 'Are you currently being treated by a psychologist or psychiatrist?';

  @override
  String get onboardingMedicalCheckPassedTitle => 'Medical check completed!';

  @override
  String get onboardingMedicalCheckPassedBody => 'You already completed 2 out of 3 sections. Great, you’re nearly done!';

  @override
  String get onboardingMedicalCheckFailedTitle => 'Please check with your doctor or specialist!';

  @override
  String get onboardingMedicalCheckFailedBody => 'Please ask your doctor, specialist or psychologist before you use this app if it fits to your medical condition and / or treatment of:';

  @override
  String get onboardingMedicalCheckFailedBody2 => 'Please note, we additionally offer support groups. If you would like to take part in one of these groups later on in the program, you will need permission from your psychologist/psychiatrist first';
  ...
  @override
  String get onboardingMentalHealthIntroTextThree => 'You can take a break in between as long as you finish this section within one hour.';

  @override
  String get onboardingMentalHealthIntroTextThreeAccent => 'within one hour';

  @override
  String get onboardingMentalHealthIntroTextFour => 'If you do take more than an hour, you will need to start this section over again.';

  @override
  String get onboardingMentalHealthIntroTextFive => 'You will receive your results immediately after the questions.';

  @override
  String get onboardingMentalHealthIntroTextSix => 'Please note that these test results are not a diagnosis. A diagnosis can only be made by a doctor or psychologist.';
  ...
  @override
  String get onboardingWho8Question => 'Please indicate for each of the given statements which is closest to how you have been feeling over the last two weeks.';
  ...
  @override
  String get onboardingPhq15Question => 'During the past four weeks, how much have you been bothered by any of the following problems?';

  @override
  String get onboardingPhq8Question => 'Over the last two weeks, how often have you been bothered by any of the following problems?';

  @override
  String get onboardingStartAgain => 'Start again';

  @override
  String get onboardingWho5ResultTestMinimal => 'Regarding your general well-being, you have indicated that in the last two weeks your well-being has been severely limited, and you have felt unwell most of the time. If you feel unwell for a longer period, we recommend that you consult a psychologist or your doctor to check these symptoms. You can find psychologists here:';

  @override
  String get onboardingWho5ResultTestHigh => 'In terms of your general well-being, you indicated that you have generally felt balanced, joyful, and relaxed over the past two weeks. This result indicates a good state of well-being.';

  @override
  String get onboardingPhq15ResultMinimal => 'You have stated that you have had no or few physical ailments in the last four weeks. That’s great.';

  @override
  String get onboardingPhq15ResultMild => 'You have stated that you have been bothered by a few physical problems in the last four weeks. Mild physical problems can also be a sign of stress. It could be helpful to reduce stress. \nTo clarify whether these ailments are related to stress, please consult your doctor.';

  @override
  String get onboardingPhq15ResultMedium => 'You have stated that a number of physical ailments have bothered you over the past four weeks. A consultation with your doctor is recommended to check whether these are temporary. The symptoms can be a reaction of your body to stress or emotional issues.';

  @override
  String get onboardingPhq15ResultHigh => 'You have stated that many physical ailments have bothered you in the last four weeks. Please consult your doctor to check these symptoms. These symptoms may have a medical cause or indicate a somatization disorder. \n\nThis program is not a substitute for mental health diagnosis or psychological treatment. In order to have a closer look at the symptoms and to treat them, if necessary, we recommend consulting your doctor or a psychologist. You can find addresses here:';

  @override
  String get onboardingGad7ResultMinimal => 'You have stated that you were at ease most of the time in the last two weeks. Your everyday life is not affected by anxiety. Great, keep it up.';

  @override
  String get onboardingGad7ResultMild => 'You have stated that in the last two weeks you have had problems to relax from time to time. You may also have felt nervous, anxious, or on edge. Don’t be concerned about it. These may be temporary symptoms. Give yourself a break to relax more often. \nBut if the symptoms worsen, we recommend consulting your doctor or a psychologist.';

  @override
  String get onboardingGad7ResultMedium => 'You have stated that you have felt nervous or anxious more than half the time in the last two weeks. You may also have not been able to stop or control worrying. This can be a burden for you in your daily life.\n\nIf the symptoms persist or worsen, we recommend consulting your doctor or a psychologist.';

  @override
  String get onboardingGad7ResultHigh => 'You have stated that you have felt nervous or anxious nearly every day in the last two weeks. You may also have not been able to stop or control worrying. These symptoms could indicate an anxiety disorder.\n\nIn order to have a closer look at the symptoms and to treat them, if necessary, we recommend consulting your doctor or a psychologist. You can find addresses here:';

  @override
  String get onboardingPhq8ResultMinimal => 'You have stated that your mood was not affected most days in the last two weeks. Great, keep it up and look out for all the positive things you will come across on your journey.';
  ...
  @override
  String get onboardingPhq8ResultHigh => 'You have stated that your mood has often been significantly affected in the last two weeks. You have indicated that you have felt depressed and have often suffered from listlessness or dejection. The symptoms indicate current psychological distress with emotional impairment. These may be indications of a temporary depressive episode. \n\nThis program is not a substitute for mental health diagnosis or psychological treatment. In order to have a closer look at the symptoms and to treat them, if necessary, we recommend consulting your doctor or a psychologist. You can find addresses here:';

  @override
  String get onboardingPhq8ResultHighest => 'You have stated that your mood has been significantly affected almost every day for the past two weeks. You have indicated that you have felt depressed and have often or constantly suffered from listlessness or dejection. These symptoms currently indicate a high level of psychological distress with emotional impairment and could be an indication of depression.\n\nThis program is not a substitute for mental health diagnosis or psychological treatment. In order to have a closer look at the symptoms and to treat them, if necessary, we recommend consulting your doctor and a clarification by a psychologist. You can find addresses here:';

  @override
  String get onboardingPhq8FinalResultHigh1 => 'The questionnaire results indicate that you are currently experiencing notable mental distress.';

  @override
  String get onboardingPhq8FinalResultHigh2 => 'Unfortunately, the program is not suitable for people who are currently experiencing considerable mental distress, as participation in this program could place additional stress on you.';

  @override
  String get onboardingPhq8FinalResultHigh3 => 'In order to have a closer look at these symptoms and to treat them, we recommend consulting a psychologist. You can find addresses here:';

  @override
  String get onboardingPhq8FinalResultHigh4 => 'We invite you to repeat the test when these symptoms have subsided so that you can focus all your energy on your weight-loss journey.';

  @override
  String get onboardingIfYouHaveSuicidalThoughts => 'If you are in an acute crisis or having suicidal thoughts, please contact one of the 24-hour toll-free emergency numbers immediately:';

  @override
  String get onboardingPersonalProgram => 'Based on your information, we tailor the program to you personally.';

  @override
  String get onboardingSupportMessage => 'We would like to support you on your journey in the best possible way and tailor the program to you personally.';

  @override
  String get onboardingFeelLimited1 => 'It turned out that you currently feel limited by anxiety and physical symptoms. We recommend you talk to a primary care physician or psychologist.';

  @override
  String get onboardingFeelLimited2 => 'It turned out that you currently feel limited by physical symptoms. We recommend you talk to a primary care physician or psychologist.';

  @override
  String get onboardingFeelLimited3 => 'It turned out that you currently feel limited by anxiety symptoms. We recommend you talk to a primary care physician or psychologist.';

  @override
  String get onboardingFeelLimited4 => 'It turned out that you are troubled in several areas at the moment.';

  @override
  String get onboardingNotATherapy => 'Please keep in mind that LeanOnMe is not a therapy.';

  @override
  String get onboardingLearnManyThings => 'However, you will learn many things that will support you in your mental and physical well-being.';

  @override
  String get onboardingUnlockAllSections => 'You will have access to all sections of the program.';

  @override
  String get onboardingAwailableAreas => 'The following areas will be available to you as you progress through the program:';

  @override
  String get onboardingUnlockBuddyMessage => 'Find a Buddy and get into a Support Group';

  @override
  String get onboardingWeWillGuideYou => 'We will guide you step by step in your weight-loss journey.\n\nHave fun with exploring!';

  @override
  String get onboardingPhq8Fail => 'We are sorry! Unfortunately, your enrollment is not possible now.';
  ...
  @override
  String get onboardingYouExceededTimeMessage => 'Sorry, but you exceeded the time limit of one hour';

  @override
  String get onboardingNoWorriesYouCanDoItLater => 'But don’t worry, you can start over';

  @override
  String get onboardingMentalResultSubText1 => 'You’ve completed the first part. Keep going. You’re doing great!';

  @override
  String get onboardingMentalResultSubText2 => 'You\'re breezing through these questions. Nicely done! You’ve reached the halfway point!';
  ...
  @override
  String get supportGroupUnlock => 'Back to basics';
  ...
  @override
  String get weightProgressionTitle => 'Weight Progression';

  @override
  String get activityTracker => 'Activity Tracker';

  @override
  String get activityTrackerLocked => 'Connect LeanOnMe to your device health trackers to push your weight loss journey to the next level. Our program + as much data as possible = a match made in heaven, allowing us to give you the best possible advice for YOU.';
}
