...
class ZoomVideoSdkSessionDialInNumberInfo {
  ...
  /// the telephone number of the current information.
  String displayNumber;

  /// the display number of the current information.
  String type;

  /// the call type of the current information.

  ZoomVideoSdkSessionDialInNumberInfo(this.countryCode, this.countryID, this.countryName,
      this.number, this.displayNumber, this.type);
